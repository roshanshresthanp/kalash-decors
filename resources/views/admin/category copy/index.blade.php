...
<ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
	...
	<li class="breadcrumb-item text-active">
		<a href="{{ route('admin.category.index')}}" class="text-active">Users</a>
	</li>
</ul>
@endsection
                ...
                <tbody>
                    @if(count($user)>0)
                        ...
                        <tr>
                            ...
                            <td>{{$user->email}}</td>
                            <td> 
                                <form id="userDelete" action="{{route('admin.category.destroy', $user->id) }}" method="post">
                                    @method('delete')
                                    @csrf
                                    <a href="{{route('admin.category.edit',$user->id)}}"><span class="fa fa-edit"></span></a> &nbsp;&nbsp;
