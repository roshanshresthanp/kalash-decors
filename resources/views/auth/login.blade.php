				...
				<div class="d-flex flex-center bgi-size-cover bgi-no-repeat flex-row-fluid" style="background-image: url(assets/media/bg/bg-1.jpg);">
					<div class="login-form text-center text-white p-7 position-relative overflow-hidden">
						...
						<div class="d-flex flex-center mb-15">
							<a href="#">
								<img src="assets/media/logos/stars.png" class="max-h-100px" alt="" />
							</a>
						</div>
						<!--end::Login Header-->
						...
						<div class="login-signin">
							...
							<form class="form" action="{{ route('login') }}">
								...
								<div class="form-group text-center mt-10">
									<button class="btn btn-pill btn-outline-white font-weight-bold opacity-90 px-15 py-3">{{ __('Login') }}</button>
								</div>
							</form>
							<div class="mt-10">
